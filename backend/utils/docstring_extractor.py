...
def extract_python_docstring(source_code: str, line_start: int) -> Tuple[Optional[str], int]:
    """
...
def extract_c_docstring(source_code: str, line_start: int) -> Tuple[Optional[str], int]:
    ...
    # Look backwards from line_start for /** ... */ block
    doc_lines = []
    in_doc_block = False
    
    # Check up to 10 lines before the symbol
...
def extract_assembly_docstring(source_code: str, line_start: int) -> Tuple[Optional[str], int]:
    """
...
def extract_cobol_docstring(source_code: str, line_start: int) -> Tuple[Optional[str], int]:
    """
    ...
    # Look backwards for COBOL comment lines (* or *>)
    for i in range(line_start - 1, -1, -1):
        line = lines[i]
        stripped = line.strip()
        
        # COBOL comment: * in column 7 or *> anywhere
...
def extract_docstring(source_code: str, language: str, line_start: int) -> Tuple[Optional[str], int]:
    """
