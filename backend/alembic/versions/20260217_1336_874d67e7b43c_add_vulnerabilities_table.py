...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_vulnerabilities_repository_id'), table_name='vulnerabilities')
...
def downgrade() -> None:
    ...
    sa.Column('owasp_category', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['repository_id'], ['repositories.id'], name=op.f('vulnerabilities_repository_id_fkey'), ondelete='CASCADE'),
